...
export class RosarioComponent {
  ...
  personas = ["Eric Marrero", "Eloy Barbero", "Eloy Roca", "Luciano Rojas", "Jose Rafael Santana",
  "Jacinto Romero","Juan Valles","Cristobal Colon","Eduard Suarez","Celso Salas",
  "Robin Hood","Pelé","Maradona","Obama","Donald Trump",
  "Gines Sainz","Ricard Montiel","Michael Jackson","Alberto Fernandez","Macri"]
